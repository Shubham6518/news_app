...
class NewsController extends GetxController {
  ...
  Future<void> getAppleNews() async {
    ...
    var baseURL =
        "https://newsapi.org/v2/everything?q=apple&from=2024-03-21&sortBy=popularity&apiKey=ea97c6bb67b040759084c3c20ea5e5cf";
    try {
      var response = await http.get(Uri.parse(baseURL));
      print(response);
      if (response.statusCode == 200) {
  ...
  Future<void> getTeslaNews() async {
    ...
    var baseURL =
        "https://newsapi.org/v2/everything?q=tesla&from=2024-3-1&sortBy=publishedAt&apiKey=ea97c6bb67b040759084c3c20ea5e5cf";
    try {
      var response = await http.get(Uri.parse(baseURL));
      print(response);
      if (response.statusCode == 200) {
  ...
  Future<void> getBusinessNews() async {
    ...
    var baseURL =
        "https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=ea97c6bb67b040759084c3c20ea5e5cf";
    try {
      var response = await http.get(Uri.parse(baseURL));
      print(response);
      if (response.statusCode == 200) {
